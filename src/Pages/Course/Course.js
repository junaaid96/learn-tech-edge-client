...
const CourseDetails = () => {
    ...
    const { _id, title, details, picture, rating, author, total_enroll, duration } = courseDetails[0];
            ...
            <Row className="gap-4">
                ...
                <div className="text-end">
                    <Pdf targetRef={ref} filename="course-details.pdf">
                        {({ toPdf }) => <Button variant='dark' className='mt-5 w-25' onClick={toPdf}>Generate Pdf</Button>}
                    </Pdf>
                </div>
            </Row>
        </Container>
